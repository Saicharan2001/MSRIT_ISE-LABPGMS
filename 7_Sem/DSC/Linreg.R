...
# Other code for Linear Regression - http://www.sthda.com/english/articles/40-regression-analysis/167-simple-linear-regression-in-r/
...
plot(y,x,col = "red",main = "Height and Weight Regression",abline(lm(x~y)),pch=16,xlab = "Weight in Kg",ylab = "Height in cm")  
# Saving the file.  
dev.off()  
