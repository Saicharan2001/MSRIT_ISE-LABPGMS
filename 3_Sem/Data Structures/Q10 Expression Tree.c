...
*******************************************************************************/
/* @Author: Dr.Mydhili K Nair, Professor, ISE DEPT, MSRIT
 C program to implement postfix expression tree and calculating
 its value */
/*
 Input: 4+6-2*3 Value is 16 Inorder is 4+6-2*3
 54*82-+ Value s 26 Inorder is: 5*4+8-2
 */
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
