		...
		jb1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Connection conn =DriverManager.getConnection("jdbc:mysql://localhost:3306/test1?characterEncoding=utf8","root", "cybersecurity");
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (conn != null) {
						...
						String Credit1 = jtf24.getText();
						int cr = Integer.parseInt(Credit1);
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					if (conn != null) {
						...
						String query3 = "SELECT * FROM Representative WHERE RepNo IN (SELECT RepNo FROM Customer)";
