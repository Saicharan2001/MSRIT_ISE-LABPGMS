...
public class StudentClass implements ActionListener {
	...
	JLabel jl10 = new JLabel("Enter sgpa of VI sem");
	...
	JComboBox cat = new JComboBox();  // Dropdown box
	...
	StudentClass()
	{
		...
		// Adding textfields to their respective labels
		f1.add(jl1);  
		f1.add(name);
		f1.add(jl13);
		f1.add(usn);
	...
	// actionPerformed is a predefined method
	public void actionPerformed(ActionEvent evt)
	{
		...
		//check for validations
			try
				...
				if(v1<18 || v1>35)
				{
					String age1=JOptionPane.showInputDialog(null,"Enter valid Age"); // showMesssageDialog , showConfirmDialog , showInputDialog
					age.setText(age1);
				}
			}
		...
		else if(evt.getSource()==done) //to submit and store the information into collection
		{
