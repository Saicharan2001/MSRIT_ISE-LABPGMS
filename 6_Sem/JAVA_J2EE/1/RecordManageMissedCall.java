...
//                Long tel_num1;
//                tel_num1=num;
//                String name1; // = DataBaseCallers.sc.next();
//                // check for name in the Database
//                if (DataBaseCallers.hm.containsKey(tel_num1))
//                    name1 = DataBaseCallers.hm.get(tel_num1);
//                else
//                    name1 = "Private Caller";
//                MissedCallDetails mcd1 = new MissedCallDetails(cb1, tel_num1, name1);
//                
//                while (it1.hasNext()) {
//                    i++;
//                    MissedCallDetails m1 = it1.next();
//                    if (m1.tel_num == mcd1.tel_num) {
//                        flag = true;
//                        amiss.remove(m1);
//                        break;
//                    }
//                }
                for(int a = 0; a < amiss.size(); a++)
				{
                	j++;
					MissedCallDetails missedCaller = amiss.get(a);
					if(missedCaller.tel_num.equals(num))
					{
						flag=true;
						amiss.remove(a);
